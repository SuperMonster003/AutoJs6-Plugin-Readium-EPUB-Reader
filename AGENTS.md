...
- `annotations/AnnotationPolicyTest`, `AnnotationJsonTest`, `AnnotationListingTest` (P9): 归一化 (href / 引文 / 时间), 同处判定, 阅读顺序与最新优先排序, 迁移并集与上限, 预览截断; 契约 JSON 字段; 面板的章节分组.
