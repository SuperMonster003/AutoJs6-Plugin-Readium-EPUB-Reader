...
- 附带发现 3 (设备矩阵): 另一会话接入的 Redmi 12C (`22120RN86C`, API 33, en-US) 已解锁且装有宿主, 本轮门禁把它作为第三台设备 (API 24 / 33 / 35); Sony G8441 API 28 仍处于指纹锁 (从 P2.5 起), 其 P2.5 与 P2.6 全量门禁继续欠着, 解锁后按 `build/p25_gate.sh BH900ASK9E` / `build/p26_gate.sh BH900ASK9E` 补跑并追加到路线图.
- 下一步: P2.7 手势 / 按键 / 链接; P0.3 外部样本仍待网络许可; Sony API 28 的 P2.5 / P2.6 门禁待解锁后补跑.
