...
> Etapa actual (compilación de desarrollo 1.0.0): el lector abre el libro con la configuración predeterminada de Readium, ofrece un índice, recuerda la posición de lectura de cada libro y proporciona modo de desplazamiento, zonas de toque, teclas de volumen y modo inmersivo. Los marcadores, las preferencias, la búsqueda de texto completo, la lectura en voz alta, el diseño fijo, la importación de fuentes, la entrada independiente y la API de scripts `epub` están planificados en ROADMAP.md y aún no están disponibles.
...
4. Use el botón de índice de la barra de herramientas para saltar entre capítulos, toque el tercio izquierdo o derecho de la página o pulse las teclas de volumen para pasar páginas, y toque el centro para ocultar o mostrar la barra de herramientas; pulse Atrás para cerrar el lector, la posición se recuerda.
...
Todavía no. Las preferencias de lectura (fuente, tamaño, interlineado, márgenes, temas) llegan con el hito de preferencias; la compilación actual ofrece modo de desplazamiento o paginado y usa los valores predeterminados de Readium para todo lo demás.
