...
> Текущий этап (сборка разработки 1.0.0): читалка открывает книгу с настройками Readium по умолчанию, предлагает оглавление, запоминает позицию чтения каждой книги, предоставляет режим прокрутки, зоны касания, кнопки громкости и полноэкранный режим, а также панель настроек размера текста, шрифта, интервалов, выравнивания, колонок и тем, которая может следовать ночному режиму хоста, импортирует ваши собственные шрифты TTF или OTF и поддерживает вертикальные книги CJK и книги с письмом справа налево, а книги с фиксированной версткой показывает по одной странице или разворотом и ищет по всей книге, а также хранит закладки и поддерживает внутренние ссылки, примечания и изображения с настраиваемыми зонами касания и клавиатурой. Чтение вслух, отдельная точка входа и скриптовый API `epub` запланированы в ROADMAP.md и пока недоступны.
