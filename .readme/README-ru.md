...
Да. Откройте панель настроек из панели инструментов, чтобы задать размер текста, шрифт (по умолчанию издателя, с засечками, без засечек, моноширинный или шрифты доступности, поставляемые с Readium), межстрочный интервал, поля, интервалы, выравнивание, колонки и тему (светлая, сепия, темная или как в хосте). Импорт собственных файлов шрифтов появится на одном из следующих этапов.
