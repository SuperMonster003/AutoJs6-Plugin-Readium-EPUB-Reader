...
- تعمل القراءة بصوت عال في خدمة تشغيل وسائط غير مصدرة لا توجد إلا أثناء القراءة وتتوقف عند إيقافها أو انتهاء الكتاب أو إغلاق القارئ; يمر النص إلى محرك تحويل النص إلى كلام المختار في إعدادات النظام, ولا يحتفظ الملحق بقفل إيقاظ.
