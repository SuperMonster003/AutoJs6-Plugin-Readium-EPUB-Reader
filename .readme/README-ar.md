...
- خدمة برمجة نصية محمية: تصدر خدمة `org.autojs.plugin.EPUB` خلف إذن الملحق, ولا تخدم إلا حزمة مضيف AutoJs6 ذات التوقيع المطابق, وتفحص كل طلب وفق حدود ثابتة (طول href, نافذة النص, صفحات البحث, حجم الخيارات, 8 كتب مفتوحة, 64 ميغابايت لكل مورد), ولا تبدأ القارئ من الخلفية أبدا.
