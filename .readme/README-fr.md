...
- La lecture à voix haute s'exécute dans un service de lecture multimédia non exporté qui n'existe que pendant la lecture et s'arrête quand vous l'arrêtez, à la fin du livre ou à la fermeture de la liseuse ; le texte est confié au moteur de synthèse vocale choisi dans les réglages du système, et le plugin ne détient aucun verrou de réveil.
